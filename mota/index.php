...
$category_filter_format = (isset($_GET['format'])) ? $_GET['format'] : ''; // Correction ici
    ...
    <div class="filtres-container">
        <div class="filtres-gauche">
            ...
            <select id="categorie-select" class="filtre" name="category">
                <option disabled="disabled" value="all">Catégories</option>
                <?php
            ...
            <select id="format-select" class="filtre" name="format"> 
                <option disabled="disabled" value="all">Formats</option>
                <?php
        ...
        <div class="filtres-droite">
            ...
            <select id="order-select" class="filtre" name="category">
                <option value="-" disabled="disabled">Tri par</option>
...
<section class="justify-center" id="photos-accueil-container">
...
<!-- script js responsable du HOVER sur les cards de la page d accueil --> 
<script>
        ...
        if (mutation.type === 'childList') {
            ...
            mutation.addedNodes.forEach(function (addedNode) {
                ...
                if (addedNode.classList && addedNode.classList.contains('photo-bloc')) {
                    ...
                    // console.log('hover APPLIQUE à addedNode');
                    // Applique les effets de survol à ce nouveau nœud
                }
            });
        }
    });
